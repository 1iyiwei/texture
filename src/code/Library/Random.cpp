...
int Random::UniformInt(const int min_value, const int max_value)
{
    return static_cast<int>(floor(UniformRandom()*(max_value - min_value + 1)))%(max_value - min_value + 1) + min_value;
}
